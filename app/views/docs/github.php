...
<p>Creating new apps on <?= $provider->name ?> can be done from your account settings page. To create an application you'll need a <?= $provider->name ?> account.</p>
...
<ul>
	<li><b>Application Name</b> - The name of you application</li>
	<li><b>Homepage URL</b> - The root url of your site <code>http://example.com/</code></li>
	<li><b>Authorization callback URL</b> - OAuth callback URL <code>http://example.com/oauth/<?= Str::lower($provider->name) ?></code></li>
	<li><b>Application Description</b> - App description. <i>optional</i></li>
</ul>
