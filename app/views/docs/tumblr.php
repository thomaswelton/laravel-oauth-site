...
<ul>
	...
	<li><b>Application website</b> - The root url of your site <code>http://example.com/</code></li>
	<li><b>Default callback URL</b> - OAuth callback URL <code>http://example.com/oauth/<?= Str::lower($provider->name) ?></code></li>
</ul>
...
<p>Next we need to add OAuth Consumer Key and Secret Key to our <a href="<?= url('docs#configuration') ?>" target="_blank">configuration file</a>.</p>
<p>Find and update the key and secret, then give yourself a pat on the back. You're all finished.</p>
<ul>
	<li><b>key</b> - OAuth Consumer Key</li>
