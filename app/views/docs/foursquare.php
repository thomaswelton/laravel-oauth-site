...
<ul>
	<li><b>App Name</b> - The name of you application</li>
	<li><b>Welcome page url</b> - The root url of your site <code>http://example.com/</code></li>
	<li><b>Redirect URI(s)</b> - OAuth callback URL <code>http://example.com/oauth/<?= Str::lower($provider->name) ?></code></li>
</ul>
